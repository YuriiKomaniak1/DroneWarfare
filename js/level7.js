...
import { BMP2, Guntruck, Tigr, BTR82 } from "./enemies/vehicle.js";
const gameData = JSON.parse(localStorage.getItem("gameData"));

let enemies = [];
let vehicles = [];
gameData.looseScore = 1260;
gameData.initialLooseScore = 1260;
gameData.winScore = 3780;
...
createEnemySquad(7, 1, 1, 450);
createEnemySquad(7, 1, 1, 900);
createEnemySquad(7, 1, 1, 1350);
setTimeout(() => {
  addVehicle(Tigr, 750, 1, 0, 0);
}, 8500);
setTimeout(() => {
  addVehicle(BMP2, 400, 0, 0, 0, 2);
}, 6500);
setTimeout(() => {
  addVehicle(BMP2, 1600, 0, 0, 0, 2);
}, 7000);
setTimeout(() => {
  addVehicle(Guntruck, 1150, 1, 0, 0, 0);
}, 9000);
setTimeout(() => {
  addVehicle(BTR82, 1000, 0, 0, 0, 2);
}, 6000);
setTimeout(() => {
  addVehicle(Tigr, 1750, 1, 0, 0);
}, 8500);
